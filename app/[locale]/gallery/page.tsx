...
const TILES: Tile[] = [
  ...
  { src: "/images/signature/signature-01.png",  alt: "ADido 시그니처 작업",    span: "col-span-6 md:col-span-4 aspect-[4/5]" },
  { src: "/images/signature/signature-02.png",  alt: "ADido 시그니처 작업",    span: "col-span-6 md:col-span-4 aspect-[4/5]" },
  { src: "/images/lounge-waiting.jpg",          alt: "라운지 대기 공간",       span: "col-span-12 md:col-span-7 aspect-[16/10]" },
  { src: "/images/signature/signature-03.png",  alt: "ADido 시그니처 작업",    span: "col-span-6 md:col-span-5 aspect-[4/5]" },
  { src: "/images/signature/signature-04.png",  alt: "ADido 시그니처 작업",    span: "col-span-6 md:col-span-4 aspect-[4/5]" },
  { src: "/images/styling-chairs-front.jpg",    alt: "스타일링 체어 정면",     span: "col-span-6 md:col-span-4 aspect-[4/5]" },
  { src: "/images/signature/signature-05.png",  alt: "ADido 시그니처 작업",    span: "col-span-12 md:col-span-4 aspect-[4/5]" },
  { src: "/images/signature/signature-06.png",  alt: "ADido 시그니처 작업",    span: "col-span-6 md:col-span-4 aspect-[4/5]" },
  { src: "/images/signature/signature-07.png",  alt: "ADido 시그니처 작업",    span: "col-span-6 md:col-span-4 aspect-[4/5]" },
  ...
  { src: "/images/signature/signature-08.png",  alt: "ADido 시그니처 작업",    span: "col-span-12 md:col-span-12 aspect-[16/9]" },
